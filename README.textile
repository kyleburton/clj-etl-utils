...
This branch is for Clojure 1.2 Support.  All clj-etl-util versions released from this branch shall have a 1.0.x version numbering scheme.  Clojure 1.3 support will be on the master branch.
