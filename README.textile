...
The master branch is for Clojure 1.3 suport.  All clj-etl-utils versions released from this branch shall have a 1.3.x version numbering scheme.  Clojure 1.2 support will be on the clojure-1.2 branch.
